...
$(function() {
    ...
    $.widget("unc.jbPivot", {
        ...
        _renderHtml: function() {
            ...
            S += "<th id=\"groupAllLabelTh\" style='padding:0;background: #ffffff;' width='100' height='50' colspan=\"" + (this.xfields.length + 1) + "\" rowspan=\"" + (this.yfields.length + 2) + "\"";
            ...
            for (y = 1; y <= this.yfields.length; y++) {
                ...
                if(tabley.length>1 || this.zfields.length>1){
                    S += "<td style='background:lightgray' class='summary line_top_3 line_bottom_3 line_left_0  line_right_1'";
                    S += " >";
                    S += "</td>";
                }
                S += "</tr>\n";
            ...
            if(this.zfields.length>1 || tabley.length >1){
                S += "<th style='background:lightgray' class='summary line_top_3 line_bottom_3 line_left_0  line_right_1'";
                S += " >";
                S += "</th>";
            }
            ...
            for (y = 0; y < tablex.length; y++) {
                ...
                if(tabley.length>1){
                    rowtd += "<td style='background:lightgray' class='summary line_top_3 line_bottom_3 line_left_0  line_right_1'>";
            ...
            if ((this.options.summary) && (this.zfields.length > 0)) {
                S += "<tr>";
                S += "<td style='background:lightgray' colspan='" + (this.xfields.length + 1) + "'";
                S += " >";
                S += "</td>";
        ...
        _format: function(value, field, fieldName) {
            ...
            if(typeof value == 'number'){
                ...
                value = value.toFixed(numberDecimals);
                value = value.toString();
                value = value.replace(/(\d)(?=(\d{3})+(?!\d)(?=\W))/g, "$1"+digitGroupingSeparator);
