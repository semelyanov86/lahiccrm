 ...
 * All Rights Reserved.
 *************************************************************************************/
Vtiger_Edit_Js("VReports_Edit_Js",{
	...
	getInstance : function(step) {
		if(step in VReports_Edit_Js.instance ){
			return VReports_Edit_Js.instance[step];
		} else {
			...
			VReports_Edit_Js.instance[step] =  new window[moduleClassName]();
			return VReports_Edit_Js.instance[step]
		}
	},
			...
			form.vtValidate({
				submitHandler:function(form,event){
					...
					thisInstance.currentInstance.submit().then(function(data){
						if(data.indexOf('index.php?module=VReports&view=PivotDetail&record=') !== -1){
