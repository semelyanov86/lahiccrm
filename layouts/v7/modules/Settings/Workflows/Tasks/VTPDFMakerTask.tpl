    ...
    <div class="row">
        <div class="col-sm-9 col-xs-9">
            <div class="row form-group">
                ...
                <div class="col-sm-8 col-xs-8"><input type="text" name="title" value="{$TASK_OBJECT->title}" id="task_title" data-rule-required="true" class="inputElement"></div>
            </div>

            <div class="row form-group">
                <div class="col-sm-2 col-xs-2">{vtranslate('LBL_DOC_DESC','PDFMaker')}</div>
                <div class="col-sm-8 col-xs-8">
                    <textarea name="description" class="inputElement">{$TASK_OBJECT->description}</textarea>
                </div>
            </div>
            ...
            <div class="row form-group">
                ...
                <div class="col-sm-8 col-xs-8">
                    <select id="task_folder" name="folder" class="select2">
            ...
            <div class="row form-group">
                ...
                <div class="col-sm-8 col-xs-8">
                    <select id="task_template" name="template" class="select2">
            ...
            <div class="row form-group">
                ...
                <div class="col-sm-8 col-xs-8">
                    ...
                    <select id="task_template_language" name="template_language" class="select2">
