...
{strip}
    ...
    <div class="vte-login-container">
        <div class="logo">
            <img src="test/logo/logo-title-small.png" />
        </div>
        <div style="margin-left: -10px">
                    ...
                    <ul class="bxslider">
                        <li>
                                <div id="slide0" class="slide">
                                    <img class="pull-left" src="test/logo/Dostavka-vody.png">
                                </div>
                            </li><li>
                                <div id="slide1" class="slide">
                                    <img class="pull-left" src="test/logo/Dostavka-vody2.png">
                                </div>
                            </li>
                    </ul>
                </div>
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 login-area">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 site-info">
                    <h1 class="login-header">Aqua-Kristal MMC</h1>
                    <p>Система управления клиентами VtigerCRM для компании по доставке воды</p>
                </div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 login-more-info vte-user-login">
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6 social">
                            <a class="social" target="_blank" href="https://www.facebook.com/itvolga21">
                                            <i class="icon-social-facebook icons"></i>
                                        </a><a class="social" target="_blank" href="http://vk.com/itvolga21">
                                            <i class="icon-social-twitter icons"></i>
                                        </a><a class="social" target="_blank" href="https://www.youtube.com/channel/UCyGdcOdG2n6mwfewfUKWWIw">
                                            <i class="icon-social-youtube icons"></i>
                                        </a>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-6 copy-right">
                            <small>Center of Information Technologies VtigerCRM</small>
                        </div>
                    </div>
                </div>
