    ...
    <table class="table table-bordered blockContainer showInlineTable equalSplit detailview-table" style="width: 500px;">
        <tr>
            ...
            <td class="fieldValue medium">
                <input class="inputElement" type="text" value="{if $FIELD_DATA['fieldlabel'] neq ''}{$FIELD_DATA['fieldlabel']}{else}{vtranslate('Team', 'Team')}{/if}" name="fieldlabel" id="fieldlabel" style="width: 80%;"/>
            </td>
        </tr>
        <tr>
            <td class="fieldLabel medium">
            ...
            <td class="fieldValue medium">
                ...
                <div class="row-fluid">
                    <div class="select-search" >
                        <select class="inputElement select2" name="fieldType" id="fieldType" style="width: 80%;">
                            {foreach item=LABEL key=VALUE from=$OPTIONS}
                                <option value="{$VALUE}" {if $VALUE eq $FIELD_TYPE}selected="selected" {/if}>{vtranslate($LABEL,'Team')}</option>
                            {/foreach}
                        </select>
                    </div>
                </div>
        ...
        <tr>
            ...
            <td class="fieldValue medium">
                <input class="inputElement" type="text" {if $FIELD_TYPE neq 2 } disabled="disabled" {/if} value="{if $FIELD_CUSTOM_DATA['fieldlabel'] neq ''}{$FIELD_CUSTOM_DATA['fieldlabel']}{else}{vtranslate('LBL_FOLLOWERS', 'Team')}{/if}" name="fieldcustom" id="fieldcustom" style="width: 80%;"/>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td class="fieldValue medium">
                <input class="inputElement" type="text" name="teammmebers" id="teammembers" value="{if $FIELD_TEAMMEMBERS_DATA['fieldlabel'] neq ''}{$FIELD_TEAMMEMBERS_DATA['fieldlabel']}{else}{vtranslate('LBL_TEAM_MEMBERS', 'Team')}{/if}" style="width: 80%;"/>
        ...
        <tr>
            ...
            <td class="fieldValue medium">
                ...
                <div class="row-fluid">
                    <div class="select-search" >
                        <select class="inputElement select2" multiple name="defaultGroup[]" id="defaultGroup" style="width: 80%;">
