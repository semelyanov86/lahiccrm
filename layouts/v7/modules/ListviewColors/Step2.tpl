...
{strip}
    <div class="installationContents" style="border:1px solid #ccc;padding:2%;">
        <form name="activateLicenseForm" action="index.php" method="post" id="installation_step2" class="form-horizontal">
            ...
            <div class="row">
                <center>
                <button class="btn btn-success" name="btnActivateListviewColors" type="button"><strong>{vtranslate('LBL_ACTIVATE', $QUALIFIED_MODULE)}</strong></button>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <button class="btn btn-info" name="btnOrder" type="button" onclick="window.open('http://www.vtexperts.com/extension/vtiger-listview-colors/')"><strong>{vtranslate('LBL_ORDER_NOW', $QUALIFIED_MODULE)}</strong></button>
                </center>
            </div>
        </div>
        <div class="clearfix"></div>
