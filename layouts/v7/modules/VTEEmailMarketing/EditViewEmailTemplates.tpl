...
************************************************************************************}
{strip}
<script type="text/javascript" src="layouts/v7/modules/VTEEmailMarketing/canvas/html2canvas.min.js"></script>
		...
		<div class="editViewPageDiv full-width">
			<div class="col-sm-12 col-xs-12 ">
				<form id="EditView" class="form-horizontal recordEditView"  name="EditView" method="post" action="index.php">
					<input  type="hidden" name="keytemplate" value="{$KEYTEMPLATE}"/>
					<textarea name="metadata" style="display: none !important;">{$METADATA}</textarea>
					<textarea name="template" style="display: none !important;">{$TEMPLATE}</textarea>
					...
					<div class="editViewBody">
						<div class="editViewContents">
							...
							{/if}
							{include file="partials/EditViewContents.tpl"|@vtemplate_path:"VTEEmailMarketing"}
						</div>
