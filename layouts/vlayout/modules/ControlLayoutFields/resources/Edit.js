 ...
 * All Rights Reserved.
 *************************************************************************************/
jQuery.Class("ControlLayoutFields_Edit_Js",{
},{
 	/*
	...
	registerFormSubmitEvent : function(form) {
        ...
        form.on('submit',function(e){
            ...
            if(description.val().length === 0){
                ...
                var url = 'index.php?module=ControlLayoutFields&view=Edit';
                ...
                AppConnector.request(actionParams).then(
                    function(data) {
                        ...
                        if(data) {
                            ...
                            //var jsInstance = new ControlLayoutFields_AdvanceFilter_Js();
...
jQuery(document).ready(function(){
    var jsInstance = new ControlLayoutFields_Edit_Js();
