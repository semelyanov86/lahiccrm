...
function CreateDiscountForSO($ws_entity){
    // WS id
    $taraCode = '19but';
    ...
    $soModel = Vtiger_Record_Model::getInstanceById($crmid, 'SalesOrder');
    ...
    if ($taraId) {
        $assetModule->updateDiscount($taraId, $crmid, $soModel, $taraTotal);
    }
